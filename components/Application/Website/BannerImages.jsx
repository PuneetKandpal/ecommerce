...
const BannerImages = ({ images = [] }) => {
  const imagesToShow = images.length > 0
    ? images
    : [
        { src: banner1.src, width: banner1.width, height: banner1.height, alt: 'banner 1', link: '' },
        { src: banner2.src, width: banner2.width, height: banner2.height, alt: 'banner 2', link: '' },
      ]
